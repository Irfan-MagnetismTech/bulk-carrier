...
export default [
    /* Crew Rank Management Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rank-view' },
    ...
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rank-create' },
    },
    {
        path: `/${BASE}/ranks/:rankId/edit`,
        name: `${BASE}.ranks.edit`,
        component: () => import(`../views/crew/rank/edit.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rank-edit' },
    },
    ...
    /* Crew Vessel Particulars Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-vessel-particular-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    ...
    /* Crew Policy Management Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-policy-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-policy-create' },
    },
    {
        path: `/${BASE}/policies/:policyId/edit`,
        name: `${BASE}.policies.edit`,
        component: () => import(`../views/crew/policy/edit.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-policy-edit' },
    },
    /* Crew Onboard Checklist Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-onboard-checklist-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Vessel Required Crew Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-vessel-crew-manning-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-vessel-crew-manning-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-vessel-crew-manning-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-vessel-crew-manning-view' },
    },
    /* Crew Requisition Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-requisition-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-requisition-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-requisition-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-requisition-view' },
    },
    /* Recruitment Approval Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-recruitment-approval-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-recruitment-approval-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-recruitment-approval-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-recruitment-approval-view' },
    },
    ...
    /* Crew agencies Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-profile-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-profile-create' },
    },
    {
        path: `/${BASE}/agencies/:agencyId/edit`,
        name: `${BASE}.agencies.edit`,
        component: () => import(`../views/crew/agency/edit.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-profile-edit' },
    },
    {
        path: `/${BASE}/agencies/:agencyId/show`,
        name: `${BASE}.agencies.show`,
        component: () => import (`../views/crew/agency/show.vue`),
        meta: { requiresAuth: true, role: "all", permission: 'crw-agency-profile-view' },
    },
    ...
    /* Agency Contract Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-contract-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-contract-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-contract-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-agency-contract-view' },
    },
    ...
    /* Agency Bills Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-agency-bill-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Crew Profile Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-profile-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Crew documents Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-document-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Crew documents renew Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-document-renew' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Crew Assigns Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-assignment-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
    ...
    /* Crew Attendance Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-attendance-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-attendance-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-attendance-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-attendance-view' },
    },
    ...
    /* Crew Incident Records Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-incident-record-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-incident-record-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-incident-record-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-incident-record-view' },
    },
    ...
    /* Crew Salary Structure Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-structure-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-structure-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-structure-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-salary-structure-view' },
    },
    ...
    /* Crew Bank Accounts Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-bank-account-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-bank-account-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-bank-account-edit' },
    },
    {
        ...
        meta: { requiresAuth: true, role: "all", permission: 'crw-bank-account-view' },
    },
    ...
    /* Crew Payroll Batch Routes */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-create' },
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-salary-edit' },
    },
    {
    ...
    /* Appraisal Form Start */
    {
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-form-view' },
		props: (route) => ({ page: parseInt(route.query.page) || 1 }),
	},
	{
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-form-create' },
	},
	{
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-form-edit' },
	},
	{
    ...
    /* Appraisal Record Start */
    {
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-record-view' },
		props: (route) => ({ page: parseInt(route.query.page) || 1 }),
	},
	{
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-record-create' },
	},
	{
		...
		meta: { requiresAuth: true, role: ROLE, permission: 'crw-apprisal-record-edit' },
	},
	{
    ...
    /* Appraisal Record Start */
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rest-hour-view' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    {
        ...
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rest-hour-create' },
    },
    {
        path: `/${BASE}/rest-hour-records/:restHourRecordId/edit`,
        name: `${BASE}.rest-hour-records.edit`,
        component: () => import(`../views/crew/rest-hour-record/edit.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rest-hour-edit' },
    },
    {
        path: `/${BASE}/rest-hour-records/:restHourRecordId`,
        name: `${BASE}.rest-hour-records.show`,
        component: () => import(`../views/crew/rest-hour-record/show.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rest-hour-view'  },
    },
    {
        path: `/${BASE}/rest-hour-records/report`,
        name: `${BASE}.rest-hour-records.report`,
        component: () => import(`../views/crew/rest-hour-record/report.vue`),
        meta: { requiresAuth: true, role: ROLE, permission: 'crw-rest-hour-record' },
        props: (route) => ({ page: parseInt(route.query.page) || 1 }),
    },
    /* Appraisal Record End */
