...
<template>
  <div class="flex items-center justify-between w-full my-3" v-once>
    <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Recruitment Approval Details</h2>
          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left">{{ formatDate(recruitmentApproval?.applied_date) }}</td>
              </tr>
              <tr>
