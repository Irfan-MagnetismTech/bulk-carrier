...
const { appraisalForm, appraisalFormLineObject, storeAppraisalForm, isLoading, errors } = useAppraisalForm();
const { setTitle } = Title();
const page = 'create';

setTitle('Create Appraisal Form');
</script>
<template>
    <!-- Heading -->
    <div class="flex flex-col items-center justify-between w-full my-3 sm:flex-row" v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create New Appraisal Form</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="storeAppraisalForm(appraisalForm)">
            <!-- Booking Form -->
