...
import useMaterialAdjustment from "../../../composables/scm/useMaterialAdjustment";
import useHelper from "../../../composables/useHelper.js";
import MaterialAdjustmentForm from "../../../components/scm/material-adjustment/MaterialAdjustmentForm.vue";
import usePurchaseOrder from "../../../composables/scm/usePurchaseOrder.js";

const { getMaterialAdjustment, materialAdjustment, storeMaterialAdjustment, errors, isLoading } = useMaterialAdjustment();
...
<template>
    ...
    <div class="flex flex-col items-center justify-between w-full my-2 sm:flex-row" v-once>
        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Create Material Adjustment</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="storeMaterialAdjustment(materialAdjustment)">
          <material-adjustment-form  v-model:defaultVendor="defaultVendor" :form="materialAdjustment" :page="page" :errors="errors"></material-adjustment-form>
            <!-- Submit button -->
