...
const { getMaterialAdjustment, showMaterialAdjustment, materialAdjustment, updateMaterialAdjustment, errors, isLoading } = useMaterialAdjustment();
...
<template>
    ...
    <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Edit Material Adjustment</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="updateMaterialAdjustment(materialAdjustment, materialAdjustmentId)">
            <material-adjustment-form :form="materialAdjustment" :page="page" :errors="errors"></material-adjustment-form>
            <!-- Submit button -->
