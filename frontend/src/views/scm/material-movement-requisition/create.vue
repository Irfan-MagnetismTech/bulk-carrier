...
const { getMaterialMovementRequisition, materialMovementRequisition, storeMaterialMovementRequisition, errors, isLoading } = useMaterialMovementRequisition();
const { setTitle } = Title();

setTitle('Create Material Movement Requisition');
</script>
<template>
    <!-- Heading -->
    <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
        <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Create Material Movement Requisition</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="storeMaterialMovementRequisition(materialMovementRequisition)">
          <material-movement-requisition-form :form="materialMovementRequisition" :errors="errors"></material-movement-requisition-form>
            <!-- Submit button -->
