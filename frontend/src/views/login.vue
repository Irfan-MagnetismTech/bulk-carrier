        ...
        <div class="flex items-center justify-center p-6 sm:p-8 w-full">
          <div class="w-full">
            <form class="" @submit.prevent="login(user)">
              <div>
                <label class="block mb-1 text-sm leading-relaxed tracking-tight text-gray-700 ">Email Address</label>
                <input type="email" v-model="user.email" required placeholder="Your Email" class="w-full px-4 py-2 transition duration-300 ease-in-out transform bg-gray-100 border-transparent rounded-md   focus:ring-blue-600 focus:outline-none" />
              </div>
              <div class="mt-4">
                <label class="block mb-1 text-sm leading-relaxed tracking-tight text-gray-700 ">Password</label>
                <input type="password" v-model="user.password" required minlength="6" placeholder="Your Password" class="w-full px-4 py-2 transition duration-300 ease-in-out transform bg-gray-100 border-transparent rounded-md   focus:ring-blue-600 focus:outline-none" />
              </div>
