...
const { getStoreRequisition, storeRequisition, excelExportData, getStoreCategoryWiseExcel, storeStoreRequisition,materialObject, errors, isLoading } = useStoreRequisition();
const page = ref('create');
const { setTitle } = Title();

setTitle('Create Store Requisition');
</script>
<template>
    <!-- Heading -->
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="storeStoreRequisition(storeRequisition)">
          <store-requisition-form v-model:form="storeRequisition" :errors="errors" :materialObject="materialObject" :page="page"></store-requisition-form>
            <!-- Submit button -->
