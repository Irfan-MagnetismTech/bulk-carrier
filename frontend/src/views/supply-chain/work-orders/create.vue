...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeWorkOrder(workOrder)">
          <work-order-form v-model:form="workOrder" :errors="errors" :workObject="workObject" :termsObject="termsObject" :page="page" :woLineObject="woLineObject" v-model:serviceList="serviceList"></work-order-form>
            <!-- Submit button -->
