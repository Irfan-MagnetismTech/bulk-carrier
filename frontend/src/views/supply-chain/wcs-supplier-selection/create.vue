...
import WcsSupplierSelectionForm from "../../../components/supply-chain/wcs-supplier-selection/WcsSupplierSelectionForm.vue";
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="store(wcsQuotation)">
          <!-- <material-cs-form v-model:form="quotation" :errors="errors" :page="page"></material-cs-form> -->
            <!-- Submit button -->
           <wcs-supplier-selection-form v-model:form="wcsQuotation" :errors="errors" :page="page" :formData="WcsData"></wcs-supplier-selection-form>
