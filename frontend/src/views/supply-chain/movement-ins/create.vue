...
const { getMovementIn, movementIn, storeMovementIn, materialObject, errors, isLoading } = useMovementIn();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeMovementIn(movementIn)">
          <movement-in-form v-model:form="movementIn" :errors="errors" :materialObject="materialObject" :page="page"></movement-in-form>
            <!-- Submit button -->
