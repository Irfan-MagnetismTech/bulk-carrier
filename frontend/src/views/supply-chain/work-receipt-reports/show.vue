...
import WorkReceiptReportShow from "../../../components/supply-chain/work-receipt-reports/WorkReceiptReportShow.vue";
...
<template>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
          <work-receipt-report-show v-model:form="workReceiptReport"></work-receipt-report-show>
  </div>
</template>
