...
const { getWorkReceiptReports, workReceiptReport, showWorkReceiptReport, scmWrrLineObject, scmWrrLineItemObject, woServiceList, updateWorkReceiptReport, errors, isLoading } = useWorkReceiptReport();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="updateWorkReceiptReport(workReceiptReport, workReceiptReportId)">
            <!-- <work-receipt-report-form v-model:form="materialReceiptReport" :page="formType" :errors="errors" :formType="formType" :materialObject="materialObject" :poMaterialList="poMaterialList" ></work-receipt-report-form> -->

            
            <work-receipt-report-form v-model:form="workReceiptReport" :errors="errors" :scmWrrLineObject="scmWrrLineObject" :scmWrrLineItemObject="scmWrrLineItemObject" v-model:woServiceList="woServiceList" :page="formType" :formType="formType" ></work-receipt-report-form>
