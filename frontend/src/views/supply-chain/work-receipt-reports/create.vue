...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="storeWorkReceiptReport(workReceiptReport)">
          ...
          <work-receipt-report-form v-model:form="workReceiptReport" :errors="errors" :scmWrrLineObject="scmWrrLineObject" :scmWrrLineItemObject="scmWrrLineItemObject" v-model:woServiceList="woServiceList" :page="page" :formType="formType"></work-receipt-report-form>
            <!-- Submit button -->
