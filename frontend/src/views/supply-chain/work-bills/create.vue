...
const { workBill, storeWorkBill, isLoading, errors } = useWorkBill();
...
setTitle('Create Work Bill');
</script>
<template>
    <!-- Heading -->
    
    <div class="flex items-center justify-between w-full my-3" v-once>
        <h2 class="text-xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create Work Bill</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeWorkBill(workBill)">
          <work-bill-form v-model:form="workBill" :errors="errors" :page="page"></work-bill-form>
            <!-- Submit button -->
