...
const { getMaterialReceiptReports, materialReceiptReport, storeMaterialReceiptReport,materialObject,getPrAndPoWiseMrrData, errors, isLoading,poMaterialList,mrrLineObject } = useMaterialReceiptReport();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="storeMaterialReceiptReport(materialReceiptReport)">
          <material-receipt-report-form v-model:form="materialReceiptReport" :errors="errors" :materialObject="materialObject" v-model:poMaterialList="poMaterialList" :page="page" :mrrLineObject="mrrLineObject" :formType="formType"></material-receipt-report-form>
            <!-- Submit button -->
