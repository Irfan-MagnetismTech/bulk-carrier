...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="updateMaterialReceiptReport(materialReceiptReport, materialReceiptReportId)">
            <material-receipt-report-form v-model:form="materialReceiptReport" :page="formType" :errors="errors" :materialObject="materialObject" :poMaterialList="poMaterialList" :mrrLineObject="mrrLineObject" :formType="formType"></material-receipt-report-form>
            <!-- Submit button -->
