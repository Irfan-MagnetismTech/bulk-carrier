...
const { getMaterialCs, materialCs, storeMaterialCs,materialObject, errors, isLoading,getPrWiseCs} = useMaterialCs();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeMaterialCs(materialCs)">
          <material-cs-form v-model:form="materialCs" :errors="errors" :page="page"></material-cs-form>
            <!-- Submit button -->
