...
const { getVendorBill, vendorBill, storeVendorBill, errors, isLoading } = useVendorBill();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="storeVendorBill(vendorBill)">
          <vendor-bill-form v-model:form="vendorBill" :errors="errors" :page="page"></vendor-bill-form>
            <!-- Submit button -->
