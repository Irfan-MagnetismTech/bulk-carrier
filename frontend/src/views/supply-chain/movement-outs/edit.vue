...
import MovementOutForm from "../../../components/supply-chain/movement-requisitions/MovementOutForm.vue";
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="updateMovementOut(movementOut, movementOutId)">
            <movement-requisition-form :form="movementOut" :page="formType" :errors="errors" :formType="formType" :materialObject="materialObject"></movement-requisition-form>
            <!-- Submit button -->
