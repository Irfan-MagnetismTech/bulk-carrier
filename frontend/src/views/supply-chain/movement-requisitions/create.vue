...
const { getMovementRequisition, movementRequisition, excelExportData, getStoreCategoryWiseExcel, storeMovementRequisition,materialObject, errors, isLoading } = useMovementRequisition();
const page = ref('create');
const { setTitle } = Title();

setTitle('Create Movement Requisition');
</script>
<template>
    <!-- Heading -->
    <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
        <h2 class="text-xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create Movement Requisition</h2>
