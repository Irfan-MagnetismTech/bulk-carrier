<template>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
      <form @submit.prevent="updateVessel(vessel, vesselId)">
          <!-- Port Form -->
          <vessel-form v-model:form="vessel" :errors="errors" :maritimeCertificateObject="maritimeCertificateObject"></vessel-form>
          <!-- Submit button -->
...
const { vessel, maritimeCertificateObject, showVessel, updateVessel, errors } = useVessel();
