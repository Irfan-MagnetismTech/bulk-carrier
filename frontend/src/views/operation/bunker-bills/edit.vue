<template>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 relative">
      <form @submit.prevent="updateBunkerBill(bunkerBill, bunkerBillId)">
          <!-- Port Form -->
          <bunker-bill-form v-model:form="bunkerBill" :errors="errors" :formType="formType" :bunkerObject="bunkerObject" ></bunker-bill-form>
          <!-- Submit button -->
...
const { bunkerBill, bunkerBillBunkerObject,bunkerObject, showBunkerBill, updateBunkerBill, errors } = useBunkerBill();
