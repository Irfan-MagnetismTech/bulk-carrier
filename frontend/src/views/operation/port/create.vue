<template>
  ...
  <div class="flex items-center justify-between w-full my-3 " v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create New Port</h2>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
      <form @submit.prevent="storePort(port)">
          <!-- Port Form -->
          <port-form v-model:form="port" :errors="errors" :formType="formType"></port-form>
          <!-- Submit button -->
