<template>
  <div class="flex items-center justify-between w-full my-3" v-once>
    <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Update Bunker Requistion</h2>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 relative">
      <form @submit.prevent="updateBunkerRequisition(bunkerRequisition, bunkerRequisitionId)">
          <!-- Port Form -->
          <bunker-requisition-form v-model:form="bunkerRequisition" :errors="errors" :formType="formType" :bunkerRequisitionBunkerObject="bunkerRequisitionBunkerObject"></bunker-requisition-form>
          <!-- Submit button -->
...
const { bunkerRequisition, bunkerRequisitionBunkerObject, showBunkerRequisition, updateBunkerRequisition, errors } = useBunkerRequisition();
