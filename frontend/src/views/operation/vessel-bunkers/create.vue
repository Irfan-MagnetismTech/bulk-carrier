<template>
  ...
  <div class="flex items-center justify-between w-full my-3" v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create Vessel Bunker</h2>
...
const { vesselBunker, storeVesselBunker, isLoading, errors} = useVesselBunker();
const { setTitle } = Title();

setTitle('Create Vessel Bunker');
