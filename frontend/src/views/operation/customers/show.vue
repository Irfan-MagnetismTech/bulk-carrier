<template>
  <div class="flex items-center justify-between w-full my-3" v-once>
    <h2 class="text-2xl font-semibold text-gray-700 ">Customer Details</h2>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md ">
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Customer Code </span>
            <span class="show-block">{{ customer.code }}</span>
        </label>
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Legal Name </span>
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Tax Identification</span>
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      ...
      <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Post Code</span>
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Business License No.</span>
            <span class="show-block">{{ customer.business_license_no }}</span>
        </label>
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">BIN/GST/SST No.</span>
    ...
    <div class="mt-3 md:mt-8">
      ...
      <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
          ...
          <label class="block w-full mt-2 text-sm">
              <span class="text-gray-700 ">Company Reg. No</span>
              <span class="show-block">{{ customer.company_reg_no }}</span>
          </label>
          <label class="block w-full mt-2 text-sm">
              <span class="text-gray-700 ">Email <small>(General)</small></span>
              <span class="show-block">{{ customer.email_general }}</span>
          </label>
          <label class="block w-full mt-2 text-sm">
              <span class="text-gray-700 ">Email <small>(Agreement)</small></span>
              <span class="show-block">{{ customer.email_agreement }}</span>
          </label>
          <label class="block w-full mt-2 text-sm">
              <span class="text-gray-700 ">Email <small>(Invoice)</small></span>
