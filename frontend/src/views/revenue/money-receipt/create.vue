...
const { moneyReceipt, storeMoneyReceipt  } = useMoneyReceipt();
...
<template>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="storeMoneyReceipt(moneyReceipt)">
            <money-receipt-form v-model:moneyReceipt="moneyReceipt" v-model:formType="formType" :errors="errors"></money-receipt-form>
        </form>
    </div>
</template>