<script setup>
    ...
    import ExpenditureReportForm from "../../../components/finance/ExpenditureReportForm.vue";
...
<template>
    <!-- Heading -->
    <heading :to="{ name: 'finance.expenditure-report' }" :type="'list'" :label="'Expenditure Report'"></heading>
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 overflow-x-auto scrollbar">
            <!-- Voyage Expenditure Head Form -->
            <expenditure-report-form v-model:form="expense" :heads="heads" :errors="errors"></expenditure-report-form>
            <!-- Submit button -->
    </div>
</template>