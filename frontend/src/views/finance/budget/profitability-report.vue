<script setup>
    ...
    import ReportForm from "../../../components/budget/BudgetVsExpense.vue";
...
<template>
    <!-- Heading -->
    <heading :to="{ name: 'finance.budget.index' }" :type="'list'" :label="'Budget vs Expense Report'"></heading>
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <!-- Voyage Expenditure Head Form -->

            <report-form v-model:form="expense" :heads="heads" :errors="errors"></report-form>
