<template>
  ...
  <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
    <h2 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Create New Fuel</h2>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    <form @submit.prevent="storeFuel(fuel)">
      <fuel-form v-model:form="fuel" :errors="errors"></fuel-form>
      <!-- Submit button -->
...
setTitle('Create Fuel');

const { fuel, storeFuel, isLoading, errors } = useFuel();
