<template>
    <div>
        <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': true }">
            <!-- Sidebar -->
            <aside class="sidebar relative bg-red-300 z-20 hidden w-64 overflow-y-auto dark:bg-gray-800 md:block flex-shrink-0 shadow-lg" style="transition: all 0.5s ease 0s; left: 0px">
            ...
            <aside ref="sidebar" @keydown.esc="close_side_menu()" class="sidebar fixed bg-red-300 inset-y-0 z-20 flex-shrink-0 w-64 mt-8 overflow-y-auto dark:bg-gray-800 md:hidden" style="transition: all 0.5s ease 0s; left: -260px">
