...
watch(
    ...
    (newBusinessUnit, oldBusinessUnit) => {
      if (newBusinessUnit !== oldBusinessUnit) {
        router.push({ name: "mnt.jobs.index", query: { page: 1 } })
      }
    }
);
let filterOptions = ref( {
  ...
  "filter_options": [
    ...
    {
      "rel_type": null,
      "relation_name": "mntItem.mntItemGroup.mntShipDepartment",
      "field_name": "name",
      "search_param": "",
      "action": null,
      "order_by": null,
    ...
    {
      "rel_type": null,
      "relation_name": "mntItem.mntItemGroup",
      "field_name": "name",
      "search_param": "",
      "action": null,
      "order_by": null,
