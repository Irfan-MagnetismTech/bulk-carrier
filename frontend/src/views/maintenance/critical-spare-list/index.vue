...
const { criticalSparelists, getCriticalSpareLists, deleteCriticalSpareList, isLoading } = useCriticalSpareList();
...
function confirmDelete(id) {
  Swal.fire({
    title: 'Are you sure?',
    text: "You want to change delete this critical spare!",
    icon: 'warning',
...
onMounted(() => {
  watchEffect(() => {
  getCriticalSpareLists(props.page, businessUnit.value)
    .then(() => {
  ...
  <div id="customDataTable">
    <div  class="table-responsive max-w-screen" :class="{ 'overflow-x-auto': tableScrollWidth > screenWidth }">
      ...
      <table class="w-full whitespace-no-wrap" >
          ...
          <tfoot v-if="!criticalSparelists?.data?.length">
          <tr v-if="isLoading">
