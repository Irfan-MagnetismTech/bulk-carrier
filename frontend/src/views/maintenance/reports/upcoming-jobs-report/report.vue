...
import useUpcomingJobsReport from "../../../../composables/maintenance/useUpcomingJobsReport";
import Title from "../../../../services/title";
import useHeroIcon from "../../../../assets/heroIcon";
import DefaultButton from '../../../../components/buttons/DefaultButton.vue';
import { formatDate } from "../../../../utils/helper";
const icons = useHeroIcon();
const { formParams, upcomingJobs, upcomingJobsReport, downloadUpcomingJobsReport, showReport, isLoading, errors } = useUpcomingJobsReport();

const { setTitle } = Title();
setTitle('Upcoming Jobs Report');

</script>
<template>
    <!-- Heading -->
    <div class="flex flex-col items-center justify-between w-full my-3 sm:flex-row" v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Upcoming Jobs Report</h2>
    </div>
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
        <form @submit.prevent="upcomingJobsReport(formParams)">
            <!-- Form -->
    ...
    <div v-show="showReport">
        <div v-if="upcomingJobs?.length" class="">
            ...
            <div class="w-full my-2 overflow-hidden border shadow-xs dark:border-0 px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800">
                ...
                <!-- <div class="flex justify-end">
                    <div title="Print" @click="downloadUpcomingJobsReport(formParams)" class="w-14 px-4 cursor-pointer py-2 text-sm text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                ...
                <!-- <h1 class="py-1 font-bold text-center text-white bg-green-500 text-capitalize"> Upcoming Jobs </h1> -->
                <div class="w-full">
                    ...
                    <template v-for="(itemGroup, index) in upcomingJobs" :key="index">
                        <div class="my-2">
                            ...
                            <table id="table" class="w-full whitespace-no-wrap">
                                <thead>
                                    <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 border-b dark:border-gray-700 bg-gray-300 dark:text-gray-200 dark:bg-gray-700">
        ...
        <template v-else>
        <div class="px-2 py-20 bg-white rounded-lg shadow-md dark:bg-gray-800">
