...
const { salaryHead, storeSalaryHead, isLoading, errors } = useSalaryHead();
const { setTitle } = Title();

const page = 'create';

setTitle('Create Salary Head');
</script>
<template>
    <!-- Heading -->
    <div class="flex items-center justify-between w-full my-3 " v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Create Salary Head</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeSalaryHead(salaryHead)">
            <!-- Booking Form -->
