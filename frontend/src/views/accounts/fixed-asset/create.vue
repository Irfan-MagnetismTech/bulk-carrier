...
const { fixedAsset, storeFixedAsset, isLoading, errors } = useFixedAsset();
...
<template>
    ...
    <div class="flex items-center justify-between w-full my-3 " v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Create Fixed Asset</h2>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark-disabled:bg-gray-800 overflow-hidden">
        <form @submit.prevent="storeFixedAsset(fixedAsset)">
            <!-- Booking Form -->
            <fixed-asset-form :page="page" v-model:form="fixedAsset" :errors="errors"></fixed-asset-form>
            <!-- Submit button -->
