...
const chartOfAccountId = route.params.chartOfAccountId;
const { chartOfAccount, showChartOfAccount, updateChartOfAccount, errors } = useChartOfAccount();
  ...
  <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form @submit.prevent="updateChartOfAccount(chartOfAccount, chartOfAccountId)">
            <!-- Booking Form -->
          <chart-of-account-form v-model:form="chartOfAccount" :errors="errors"></chart-of-account-form>
            <!-- Submit button -->
