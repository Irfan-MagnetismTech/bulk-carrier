...
<template>
    ...
    <div class="flex items-center justify-between w-full my-3 " v-once>
        <h2 class="text-2xl font-semibold text-gray-700 ">Create Voucher</h2>
      <default-button :title="'Voucher List'" :to="{ name: 'acc.transactions.index' }" :icon="icons.DataBase"></default-button>
    </div>
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md  overflow-hidden" :style="{ 'background-color': bgColor }">
