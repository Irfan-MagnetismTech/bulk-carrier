...
<template>
  ...
  <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
    <h2 class="text-2xl font-semibold text-gray-700 dark-disabled:text-gray-200">Approval Management</h2>
    ...
    <div class="w-full overflow-hidden">
      <div class="w-full overflow-x-auto">
        <table class="w-full whitespace-no-wrap">
          ...
          <tfoot v-if="!approvals?.length" class="bg-white dark-disabled:bg-gray-800">
          <tr v-if="isLoading">
