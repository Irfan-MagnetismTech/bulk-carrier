<template>
    ...
    <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Create Open Contract</h2>
...
const { contract, storeContract, isLoading, errors } = useOpenSlotContract();
