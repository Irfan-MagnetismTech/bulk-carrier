<template>
    ...
    <div class="flex flex-col items-center justify-between w-full my-6 sm:flex-row" v-once>
        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Create Force Load Contract</h2>
  ...
  <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
    <form @submit.prevent="storeContract(contract)" autocomplete="off">
      <!-- Booking Form -->
      <force-load-contract-form v-model:form="contract" :errors="errors" v-model:isLoading="isLoading" v-model:page="page" v-model:customers="customers" v-model:services="services"></force-load-contract-form>
...
import {ref} from "vue";
import ForceLoadContractForm from "../../../components/commercial/ForceLoadContractForm.vue";
import Title from "../../../services/title";
const { contract, storeContract, isLoading, errors } = useForceLoadContract();
...
setTitle('Create Force Load Contract');
