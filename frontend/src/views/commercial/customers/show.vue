...
<!--          <td class="px-4 py-3 text-sm">{{ agent.billing_name }}</td>-->
          ...
          <td class="px-4 py-3 text-sm">{{ agent.shipping_address }}</td>
          <td class="px-4 py-3 text-sm" v-html="agent.billing_style"></td>
        </tr>
        </tbody>
      </table>
    </div>
  ...
  <div class="w-full overflow-hidden border rounded-lg shadow-xs dark:border-0">
    <div class="w-full overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
        <tr class="text-gray-700 dark:text-gray-400" v-for="(contact,index) in customer.contact_persons" :key="index">
          ...
          <td class="px-4 py-3 text-sm">{{ contact?.purpose }}</td>
        </tr>
        </tbody>
      </table>
    </div>
