        ...
        <legend>
            <div class="input-group">
                ...
                <label class="label-group">
                    ...
                    <v-select :options="costCenters" placeholder="--Choose an option--" v-model="form.accCostCenter" label="name" class="block w-full mt-1 text-xs rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input"></v-select>
            ...
            <legend class="px-2 text-gray-700 ">Contact Person <span class="required-style">*</span></legend>
            <div class="input-group">
                <label class="label-group">
