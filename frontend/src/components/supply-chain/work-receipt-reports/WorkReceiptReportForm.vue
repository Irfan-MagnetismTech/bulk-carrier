...
import { formatDate } from '../../../config/setting';
    ...
    const {getWoList,woList,isLoading:woloading,getWoWiseWrList,wrList,isWrLoading, getWrrLineData, getWoServiceList} = useWorkReceiptReport();
    ...
    function changeWr(index) {
        ...
        props.form.scmWrrLines[index].scm_wr_id = props.form.scmWrrLines[index]?.scmWr?.id ?? null;
        props.form.scmWrrLines[index].scmWrrLineItems = [];
      //   props.form.scmMrrLines.push({
      //   scmPr: line,
      //   scm_pr_id: line.id,
      //   scmMrrLineItems: [],
      // });
      // props.poMaterialList.push([]);
      if(props.form.scmWrrLines[index].scm_wr_id && props.form.scmWo?.id){
        getWrrLineData(props.form.scmWo?.id, props.form.scmWrrLines[index]?.scm_wr_id).then((res) => {
          props.form.scmWrrLines[index].scmWrrLineItems = res;
        });
        getWoServiceList(props.form.scmWo?.id, props.form.scmWrrLines[index]?.scm_wr_id).then((res) => {
    ...
    function changeWarehouse() {
      ...
      props.form.scmWo = null;
      props.form.scm_wo_id = null;
...
// }
    ...
    function changeService(index,itemIndex) {
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scm_service_id = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.id ?? null;
      // props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].unit = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.unit ?? null;
      // props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].brand = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.brand ?? null;
      // props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].model = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.model ?? null;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].max_quantity = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.max_quantity ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].quantity = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.quantity ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].wo_composite_key = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.wo_composite_key ?? null;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].wr_composite_key = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.wr_composite_key ?? null;
      // props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].tolerence_level = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.tolerence_level ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].wr_qty = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.pr_qty ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].wo_qty = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.po_qty ?? 0;
      // props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].tolerence_quantity = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.tolerence_quantity ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].remaining_quantity = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.remaining_quantity ?? 0;
      props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].rate = props.form.scmWrrLines[index].scmWrrLineItems[itemIndex].scmService?.rate ?? 0;
    ...
    onMounted(() => {
      ...
      watchEffect(() => {
        getWoList(props.form.business_unit,props.form.purchase_center,props.form.scm_warehouse_id);
      });
  ...
  function changeWo(){
    props.form.scmWrrLines = [];
    props.form.scm_wo_id = props.form.scmWo?.id;
    // props.materialList.splice(0,props.materialList.length)
...
<template>
  ...
  <div class="justify-center w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-2">
      ...
      <label class="label-group">
        <span class="label-item-title">WO Ref <span class="text-red-500">*</span></span>
         <v-select :options="woList" placeholder="--Choose an option--" :loading="woloading" v-model="form.scmWo" label="ref_no" class="block form-input" @update:modelValue="changeWo">
          <template #search="{attributes, events}">
              <input
                  class="vs__search"
                  :required="!form.scmWo"
      ...
      <label class="label-group">
          <span class="label-item-title">WO Date</span>
          <!-- <input type="date" v-model="form.date" required class="form-input" name="date" :id="'date'" /> -->
          <!-- <VueDatePicker v-model="form.date" readonly class="form-input"  auto-apply  :enable-time-picker = "false" placeholder="dd/mm/yyyy" format="dd/MM/yyyy" model-type="yyyy-MM-dd" ></VueDatePicker> -->
      ...
      <div v-for="(scmWoLine, index) in form.scmWrrLines" :key="index"  class="w-full mx-auto p-2 border rounded-md border-gray-400 mb-5 shadow-md">
        ...
        <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
          <label class="block w-1/4 mt-2 text-sm">
            ...
            <v-select :options="wrList" placeholder="--Choose an option--" v-model="form.scmWrrLines[index].scmWr" label="ref_no" class="block form-input" @update:modelValue="changeWr(index)">
              <template #search="{attributes, events}">
                  <input
                      class="vs__search"
                      :required="!form.scmWrrLines[index].scmWr"
                      v-bind="attributes"
                      v-on="events"
                      />
              </template>
          ...
          <label class="block w-1/4 mt-2 text-sm">
              ...
              <input type="text" class="form-input vms-readonly-input" readonly :value="formatDate(form.scmWrrLines[index]?.scmWr?.raised_date)"/>
          </label>
        </div>
                  ...
                  <tr class="table_tr">
                    <td class="">
                      <table>
                        ...
                        <tr>
                          <td>Brand</td>
                          <td>
                            <input type="text" v-model="form.scmWrrLines[index].scmWrrLineItems[itemIndex].brand" class="form-input-sm vms-readonly-input" readonly>
                          </td>
                        </tr>
                        <tr>
                          <td>Model</td>
                    ...
                    <td>
                      <table>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="number" required :value="form.scmWrrLines[index].scmWrrLineItems[itemIndex].remaining_quantity" min=1 class="!text-xs form-input text-right vms-readonly-input" readonly>
                          </td>
                        </tr>
                      </table>
                    </td>
                    <td>
                      <tr>
                          <td>Qty</td>
                          <td>
                            <input type="number" required :value="form.scmWrrLines[index].scmWrrLineItems[itemIndex].tolerence_quantity" min=1 class="!text-xs form-input text-right vms-readonly-input" readonly>
                          </td>
                        </tr>
                        <tr>
                          <td>Level (%)</td>
                    ...
                    <td>
                      <table>
                        <tr>
                          <td>Qty</td>
                          <td>
                             <input type="number" required v-model="form.scmWrrLines[index].scmWrrLineItems[itemIndex].quantity" min=1 class="!text-xs form-input text-right" :max="form.scmWrrLines[index].scmWrrLineItems[itemIndex].max_quantity" :class="{'border-2': form.scmWrrLines[index].scmWrrLineItems[itemIndex].quantity > form.scmWrrLines[index].scmWrrLineItems[itemIndex].max_quantity,'border-red-500 bg-red-100': form.scmWrrLines[index].scmWrrLineItems[itemIndex].quantity > form.scmWrrLines[index].scmWrrLineItems[itemIndex].max_quantity}">
                          </td>
                        </tr>
                        <tr>
                          <td>Rate</td>
                          <td>
                            <input type="number" required v-model="form.scmWrrLines[index].scmWrrLineItems[itemIndex].rate" min=1 class="!text-xs form-input text-right">
                          </td>
                        </tr>
                      </table>
                    </td>
  ...
  <div class="flex flex-col justify-center md:flex-row md:gap-2">
    ...
    <label class="label-group col-start-1 col-span-2">
         <RemarksComponent v-model="form.qc_remarks" isRequired="true" :maxlength="300" :fieldLabel="'QC Remarks'"></RemarksComponent>
    </label>
  </div>
