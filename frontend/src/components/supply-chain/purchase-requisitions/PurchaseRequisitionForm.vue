...
<template>
  ...
  <div class="input-group">
      ...
      <label class="label-group">
          ...
          <select v-model="form.is_critical" class="block w-full mt-1 text-xs rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
  ...
  <div class="input-group !w-3/4">
    ...
    <label class="label-group">
        ...
        <v-select :options="purchase_center" placeholder="--Choose an option--" v-model="form.purchase_center" label="Product Source Type" class="block w-full mt-1 text-xs rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input"></v-select>
  ...
  <div class="input-group !w-3/4">
    <label class="label-group">
          ...
          <textarea v-model="form.remarks" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input"></textarea>
    ...
    <div class="table-responsive min-w-screen">
      <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded ">
        ...
        <table class="whitespace-no-wrap overflow-x-auto">
          ...
          <tr class="text-gray-700 " v-for="(ScmPrLine, index) in form.scmPrLines" :key="index">
            <td class="">
  ...
  <div v-else>
    <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded ">
        <legend class="px-2 text-gray-700 ">Download Excel <span class="text-red-500">*</span></legend>
        <div class="input-group !w-1/2">
                <label class="label-group">
                    <span class="label-item-title">Store Category<span class="text-red-500">*</span></span>
                    <v-select name="user" v-model="excelExportData.store_category_name" placeholder="--Choose an option--" label="Store Category" :options="store_category" class="block w-full mt-1 text-xs rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
                    </v-select>
