...
<template>
  ...
  <div class="input-group-grid">
      ...
      <label class="label-group">
          ...
          <select v-model="form.is_completed" class="block w-full mt-1 text-xs rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
  ...
  <div class="input-group !w-3/4">
    <label class="label-group">
          ...
          <textarea v-model="form.qc_remarks" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input"></textarea>
    ...
    <div class="table-responsive min-w-screen overflow-y-scroll">
      <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded ">
        ...
        <table class="whitespace-no-wrap">
          ...
          <!-- <tbody class="bg-white divide-y " v-if="form.scmWarehouse != null"> -->
          <tbody class="bg-white divide-y ">
          <tr class="text-gray-700 " v-for="(scmMrrLine, index) in form.scmMrrLines" :key="index">
            <td class="!w-72">
