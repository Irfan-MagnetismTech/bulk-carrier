<template>
    ...
    <ul class="flex flex-wrap -mb-px">
      <li class="mr-2">
        <a href="#" class="inline-flex px-4 py-4 text-sm font-medium text-center text-gray-500 border-b-2 border-transparent rounded-t-lg  group" v-on:click="toggleTabs(1)" v-bind:class="{'text-purple-600 bg-white': openTab !== 1, 'text-blue-600 rounded-t-lg border-b-2 border-blue-600 bg-gray-100': openTab === 1}">
      ...
      <li class="mr-2">
        <a href="#" class="inline-flex px-4 py-4 text-sm font-medium text-center text-gray-500 border-b-2 border-transparent rounded-t-lg  group" v-on:click="toggleTabs(2)" v-bind:class="{'text-purple-600 bg-white': openTab !== 2, 'text-blue-600 rounded-t-lg border-b-2 border-blue-600 bg-gray-100': openTab === 2}">
      ...
      <li class="mr-2">
        <a href="#" class="inline-flex px-4 py-4 text-sm font-medium text-center text-gray-500 border-b-2 border-transparent rounded-t-lg  group" v-on:click="toggleTabs(3)" v-bind:class="{'text-purple-600 bg-white': openTab !== 3, 'text-blue-600 rounded-t-lg border-b-2 border-blue-600 bg-gray-100': openTab === 3}">
      ...
      <li class="mr-2">
        <a href="#" class="inline-flex px-4 py-4 text-sm font-medium text-center text-gray-500 border-b-2 border-transparent rounded-t-lg  group" v-on:click="toggleTabs(4)" v-bind:class="{'text-purple-600 bg-white': openTab !== 4, 'text-blue-600 rounded-t-lg border-b-2 border-blue-600 bg-gray-100': openTab === 4}">
    ...
    <div v-on:click="toggleTabs(1)" v-bind:class="{'hidden': openTab !== 1, 'block': openTab === 1}">
      ...
      <div class="border border-gray-200 rounded-md my-3 p-2">
        ...
        <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
          ...
          <label class="block w-full mt-2 text-sm">
                <span class="text-gray-700 ">Mother Vessel Name <span class="text-red-500">*</span></span>
        ...
        <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
            ...
            <label class="block w-1/2 mt-2 text-sm">
                <span class="text-gray-700 ">Voyage Sequence <span class="text-red-500">*</span></span>
            ...
            <label class="block w-full mt-2 text-sm">
                <span class="text-gray-700 ">Route <span class="text-red-500">*</span></span>
        ...
        <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
          ...
          <label class="block w-full mt-2 text-sm">
              <span class="text-gray-700 ">Load Port Distance (NM) <span class="text-red-500">*</span></span>
          ...
          <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Sail Date <span class="text-red-500">*</span></span>
          ...
          <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Transit Date <span class="text-red-500">*</span></span>
      ...
      <div class="">
        ...
        <div v-for="(certificate, index) in form.opsVoyagePortSchedules" class="w-full mx-auto p-2 border rounded-mdborder-gray-400 mb-5 bg-gray-100 shadow-md">
          <label class="block w-1/4 mt-2 text-sm">
            <span class="text-gray-700 ">Operation Type </span>
          ...
          <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
                    <label class="block w-full mt-2 text-sm">
                      ...
                      <span class="text-gray-700 ">Port Code <span class="text-red-500">*</span></span>
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">ATB</span>
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">ATD </span>
          ...
          <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">Load Commence </span>
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">Load Completed </span>
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">Unload Commence </span>
                    ...
                    <label class="block w-full mt-2 text-sm">
                      <span class="text-gray-700 ">Unload Completed </span>
