<template>
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      ...
      <label class="block w-full mt-2 text-sm">
        <span class="text-gray-700 ">Certificate <span class="text-red-500">*</span></span>
      ...
      <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Certificate Type </span>
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Validity Period </span>
