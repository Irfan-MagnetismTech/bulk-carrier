<template>
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      ...
      <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 dark:text-gray-300">Report Type </span>
...
const { voyage, voyages, showVoyage, getVoyageListByVessel } = useVoyage();
...
watch(() => props.form.opsVoyage, (value) => {
  ...
  if(value) {
    ...
    getVoyageListByVessel(value?.id)
  }
}, { deep: true })
