...
<!--          <action-button :action="'edit'" :to="{ name: 'operation.voyages.dg-list.edit', params: { voyageSofId: listData.id } }"></action-button>-->
          <action-button :action="'delete'" @click="deleteVoyageSofList(listData?.id,voyageId,'dg')"></action-button>
        </div>
      </td>
    </tr>
    </tbody>
