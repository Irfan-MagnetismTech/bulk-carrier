...
.wrapper {
    @apply relative w-full py-2 mt-1 border border-gray-500 rounded cursor-pointer dark-disabled:text-gray-300 dark-disabled:border-gray-600 dark-disabled:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark-disabled:focus:shadow-outline-gray;
}
.input {
    @apply w-full mb-3 text-sm rounded dark-disabled:text-gray-300 dark-disabled:border-gray-600 dark-disabled:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark-disabled:focus:shadow-outline-gray;
}

.list-wrapper {
    @apply absolute w-full px-6 pt-4 top-9 z-50 border border-gray-500 rounded-b-lg shadow-xl bg-gray-50 dark-disabled:bg-gray-700;
}
...
.selected {
    @apply text-gray-800 dark-disabled:text-gray-200;
}
</style>