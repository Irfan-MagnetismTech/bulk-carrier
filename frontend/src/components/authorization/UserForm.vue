<template>
  ...
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    ...
    <label class="block w-full mt-2 text-sm">
      <span class="text-gray-700 dark-disabled:text-gray-300">Role <span class="text-red-500">*</span></span>
...
<!--  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">-->
<!--    <label class="block w-full mt-2 text-sm">-->
<!--      <span class="text-gray-700 dark-disabled:text-gray-300">Email Signature</span>-->
<!--      <editor v-model="form.email_signature" class="block w-full text-sm rounded dark-disabled:text-gray-300 dark-disabled:border-gray-600 dark-disabled:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark-disabled:focus:shadow-outline-gray form-input" api-key="wljvu7gtfjb8h5ou2rcxw8d5tykej98zy10x8ot83jclsm3o" />-->
