...
<template>
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      ...
      <label class="block w-full mt-2 text-sm">
        <span class="text-gray-700 ">Vessel Flag </span>
      ...
      <label class="block w-full mt-2 text-sm">
        <span class="text-gray-700 ">Position Onboard/Joining Rank <span class="text-red-500">*</span></span>
  ...
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    <label class="block w-full mt-2 text-sm">
      <span class="text-gray-700 ">Date of Joining <span class="text-red-500">*</span></span>
    ...
    <label class="block w-full mt-2 text-sm">
      <span class="text-gray-700 ">Port of Joining <span class="text-red-500">*</span></span>
    ...
    <label class="block w-full mt-2 text-sm">
      <span class="text-gray-700 ">Duration in Months <span class="text-red-500">*</span></span>
