...
<template>
  ...
  <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded ">
    <legend class="px-2 text-gray-700 ">Item List <span class="text-red-500">*</span></legend>
    <table class="w-full whitespace-no-wrap" id="table">
      ...
      <tr class="text-gray-700 " v-for="(requiredCrewLine, index) in form.crwCrewRequisitionLines" :key="requiredCrewLine.id">
        <td class="px-1 py-1">
