...
<template>
  ...
  <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded ">
    <legend class="px-2 text-gray-700 ">Checklist Item <span class="text-red-500">*</span></legend>
    <table class="w-full whitespace-no-wrap" id="table">
      ...
      <tr class="text-gray-700 " v-for="(chkList, index) in form.crwCrewChecklistLines" :key="chkList.id">
        <td class="px-1 py-1">
