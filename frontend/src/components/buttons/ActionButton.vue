...
<template>
    <router-link :to="to" class="relative" @mouseenter="isTooltipShowing = true" @mouseleave="isTooltipShowing = false">
      ...
      <div v-else-if="action == 'show'" class="tooltip">
        <svg xmlns="http://www.w3.org/2000/svg" :class="classes ?? 'icn text-green-600 dark:text-gray-600 dark:hover:text-green-600'" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div v-else-if="action == 'history'" class="tooltip">
        <svg xmlns="http://www.w3.org/2000/svg" :class="classes ?? 'icn text-indigo-500 dark:text-gray-400 dark:hover:text-indigo-500'" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div v-else-if="action == 'print'" class="tooltip">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" :class="classes ?? 'w-6 h-6'" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
