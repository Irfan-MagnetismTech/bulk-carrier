  ...
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    ...
    <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
      <label class="block w-full mt-2 text-sm">
        <span class="text-gray-700 dark-disabled:text-gray-300">Balance/Income Line <span class="text-red-500">*</span></span>
...
<!--        <Error v-if="errors?.parent_account_id" :errors="errors.parent_account_id" />-->
  ...
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    ...
    <label class="block w-full mt-2 text-sm">
      <span class="text-gray-700 dark-disabled:text-gray-300">Is Archived <span class="text-red-500">*</span></span>
