...
<!--      <svg xmlns="http://www.w3.org/2000/svg" class="icn" :class="classes ?? 'text-purple-500 dark:text-gray-400 dark:hover:text-purple-500'" viewBox="0 0 20 20" fill="currentColor">-->
