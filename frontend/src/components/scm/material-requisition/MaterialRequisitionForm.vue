...
<template>
  ...
  <div class="flex flex-col justify-center w-full md:flex-row md:gap-2">
    ...
    <label class="block w-full mt-3 text-sm md:w-4/6">
      <span class="text-gray-700 dark:text-gray-300">Note <span class="text-red-500">*</span></span>
      <input type="text" v-model="form.note" required class="block w-full form-input" />
      <Error v-if="errors?.note" :errors="errors.note" />
    </label>
    <label class="block w-full mt-3 text-sm md:w-4/6">
  ...
  <fieldset class="px-4 pb-4 mt-3 border border-gray-700 rounded dark:border-gray-400">
    ...
    <table class="w-full whitespace-no-wrap" id="table">
      ...
      <tr class="text-gray-700 dark:text-gray-400" v-for="(material, index) in form.materials" :key="index">
        ...
        <td>
          <input type="text" v-model="form.materials[index].unit_price" class="block w-full form-input">
        </td>
        <td>
          <input type="text" readonly v-model="form.materials[index].amount" class="vms-readonly-input block w-full form-input">
        </td>
