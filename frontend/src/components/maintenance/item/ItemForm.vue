  ...
  <div class="justify-center w-full grid grid-cols-1 md:grid-cols-3 md:gap-2">
      <business-unit-input :page="page" v-model="form.business_unit"></business-unit-input>
        <label class="block w-full mt-2 text-sm">
            ...
            <v-select :loading="isShipDepartmentLoading"  placeholder="Select Ship Department" :options="shipDepartments" @search="" v-model="form.mnt_ship_department_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Item Code <span class="text-red-500">*</span></span>
    ...
    <legend class="px-2 text-gray-700 ">Description</legend>
    <table class="w-full whitespace-no-wrap" id="table">
              ...
              <tbody class="bg-white divide-y ">
                <tr class="text-gray-700 " v-for="(des, index) in form.description" :key="index">
