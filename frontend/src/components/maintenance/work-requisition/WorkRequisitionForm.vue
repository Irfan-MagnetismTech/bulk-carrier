<template>
  <div class="justify-center w-full grid grid-cols-1 md:grid-cols-4 md:gap-2 ">
      ...
      <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Requisition Date <span class="text-red-500">*</span></span>
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Reference No <span class="text-red-500">*</span></span>
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Maintenance Type <span class="text-red-500">*</span></span>
        ...
        <label class="block w-full mt-2 text-sm">
            ...
            <v-select placeholder="Select Vessel" :loading="isVesselLoading"  :options="vessels" @search="" v-model="form.ops_vessel_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
        ...
        <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Ship Department <span class="text-red-500">*</span></span>
            <v-select placeholder="Select Ship Department" :loading="isShipDepartmentLoading"  :options="shipDepartments" @search="" v-model="form.mnt_ship_department_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
              <template #search="{attributes, events}">
              <input
                  class="vs__search"
        ...
        <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Item Group <span class="text-red-500">*</span></span>
            <v-select placeholder="Select Item Group" :loading="isItemGroupLoading"  :options="form.mnt_item_groups" @search="" v-model="form.mnt_item_group_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
            <template #search="{attributes, events}">
            <input
                class="vs__search"
        ...
        <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Item <span class="text-red-500">*</span></span>
            <v-select placeholder="Select Item" :loading="isItemLoading"  :options="form.mnt_items" @search="" v-model="form.mnt_item_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
              <template #search="{attributes, events}">
                <input
                    class="vs__search"
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Est. Start Date <span class="text-red-500">*</span></span>
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Est. Completion Date <span class="text-red-500">*</span></span>
        ...
        <label class="block w-full mt-2 text-sm">
            <span class="text-gray-700 ">Assign To <span class="text-red-500">*</span></span>
        ...
        <!-- <label class="block w-full mt-2 text-sm">
          <span class="text-gray-700 ">Responsible Person <span class="text-red-500">*</span></span>
            <v-select placeholder="Select Responsible Person" :options="crews" @search="" v-model="form.responsible_person_name" label="name" class="block w-full mt-1 text-sm rounded   focus:border-purple-400 focus:outline-none focus:shadow-outline-purple  form-input">
              <template #search="{attributes, events}">
                <input
                    class="vs__search"
    ...
    <div class="mt-3">
      <ul class="flex flex-wrap gap-1 text-gray-700 ">
        ...
        <div v-if="itemWiseJobLines[tab]?.length || (tab === 'added_jobs' && form.added_job_lines?.length)">
          <table class="w-full whitespace-no-wrap" id="table">
            ...
            <tbody class="bg-white divide-y ">
              <tr class="text-gray-700 " v-for="(jobLine, index) in (tab === 'added_jobs' ?  form.added_job_lines : itemWiseJobLines[tab])" :key="index">
