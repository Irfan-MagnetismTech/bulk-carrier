...
<!--        </a>-->
        <ul class="mt-6">
          ...
          <template v-if="isControlUserMenuOpen">
            ...
            <li v-if="checkSidebarMenuPermission('approval-management-show')" class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" :class="{ 'active': isActive === 'Approval Management' }">
              ...
              <router-link :to="{ name: 'authorization.approval.management.index' }" @click="addActiveClass('Approval Management')" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="w-6 h-6 ml-2" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
          ...
          <a @click="toggleModuleMenu(2)" v-if="checkSidebarParentMenuPermission(['dataencoding-vessel-show','commercial-service-show','dataencoding-port-show','dataencoding-container-type-show','dataencoding-chargetype-show','dataencoding-voyage-expenditure-head-show','dataencoding-port-expenditure-head-show','dataencoding-currency-show','dataencoding-bank-show','dataencoding-mail-template-show','dataencoding-tariff-show'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <a @click="toggleModuleMenu(3)" v-if="checkSidebarParentMenuPermission(['dataencoding-slot-partner-show','commercial-customer-show','operation-mlo-agents-show','operation-external-email-show'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <template v-if="isContactMenuOpen">
            <li v-if="checkSidebarMenuPermission('dataencoding-slot-partner-show')" class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" :class="{ 'active': isActive === 'Slot Partner' }">
              ...
              <router-link :to="{ name: 'dataencoding.slot-partner.index' }" @click="addActiveClass('Slot Partner')" class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-400">
                <svg class="w-6 h-6 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
          ...
          <a @click="toggleModuleMenu(4)" v-if="checkSidebarParentMenuPermission(['operation-voyages-show','operation-edi-converter','operation-advisory-agents','commercial-dg-container-show','commercial-fr-container-show','commercial-rf-container-show'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <template v-if="isVesselCargoMenuOpen">
            ...
            <li v-if="checkSidebarParentMenuPermission(['commercial-contract-create','commercial-open-slot-contract-show','commercial-force-load-contract-show','commercial-contract-show'])" class="relative px-6 py-1">
              <button @click="togglePagesMenu(2)" class="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" aria-haspopup="true">
                    <span class="inline-flex items-center">
                        <svg class="w-6 h-6 ml-2" viewBox="0 0 24 24"><path fill="currentColor" d="M1 6v11h1a2 2 0 1 0 4 0h12a2 2 0 1 0 4 0h1V6H1m20 9h-2V9h-2v6h-2V9h-2v6h-2V9H9v6H7V9H5v6H3V8h18v7Z"/></svg>
          ...
          <a @click="toggleModuleMenu(5)" v-if="checkSidebarParentMenuPermission(['commercial-booking-show','commercial-voyage-slot-partner-list','commercial-contract-assign-voyages','commercial-voyage-exchange-rate','documentation-particular-customer-report','documentation-schedule-report','documentation-service-report','documentation-monthwise-service-report','documentation-customer-loading-performance-report'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <template v-if="isCommercialMenuOpen">
            ...
            <li v-if="checkSidebarParentMenuPermission(['commercial-contract-create','commercial-open-slot-contract-show','commercial-force-load-contract-show','commercial-contract-show', 'commercial-customer-loading-information'])" class="">
...
<!--          </li>-->
          ...
          <a @click="toggleModuleMenu(6)" v-if="checkSidebarParentMenuPermission(['documentation-bl-generate','commercial-freight-manifest-report'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <a @click="toggleModuleMenu(7)" v-if="checkSidebarParentMenuPermission(['documentation-bl-generate','commercial-freight-manifest-report'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <template v-if="isPricingInvoicingMenuOpen">
            <li v-if="checkSidebarParentMenuPermission(['commercial-contract-create','commercial-open-slot-contract-show','commercial-force-load-contract-show','commercial-contract-show'])" class="">
            ...
            <li v-if="checkSidebarParentMenuPermission(['commercial-advanced-invoice-create','commercial-pending-invoice-create','commercial-invoice-list'])" class="">
          ...
          <a @click="toggleModuleMenu(8)" v-if="checkSidebarParentMenuPermission(['commercial-voyage-exchange-rate'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
          ...
          <a @click="toggleModuleMenu(9)" v-if="checkSidebarParentMenuPermission(['commercial-voyage-exchange-rate'])" class="flex p-2 mb-1 cursor-pointer justify-between text-sm items-center font-semibold shadow-md focus:outline-none ">
            <div class="flex ml-2">
