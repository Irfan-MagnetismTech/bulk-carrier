...
class MntCriticalVesselItemController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            $mntCriticalVesselItem = MntCriticalVesselItem::with(['opsVessel:id,name','mntCriticalItem.mntCriticalItemCat.mntCriticalFunction.mntCriticalItemCats.mntCriticalItems','mntCriticalItemSps'])->find($id);
