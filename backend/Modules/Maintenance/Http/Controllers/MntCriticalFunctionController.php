...
class MntCriticalFunctionController extends Controller
{
    ...
    {
        $this->middleware('permission:mnt-critical-function-view', ['only' => ['index', 'show']]);
        $this->middleware('permission:mnt-critical-function-create', ['only' => ['store']]);
        $this->middleware('permission:mnt-critical-function-edit', ['only' => ['show', 'update']]);
        $this->middleware('permission:mnt-critical-function-delete', ['only' => ['destroy']]);
    }
